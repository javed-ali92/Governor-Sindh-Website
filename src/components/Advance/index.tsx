...
const Advance = () => {
  return (
    <div className='xl:w-[1300px] lg:w[90%] w-[95%] m-auto mt-10 mb-10'>
      ...
      <div className='px-4 flex justify-items-stretch-center items-center h-[70px]'>
      <text>
      ...
      <div  className='overflow-hidden h-fit box_shadow rounded-lg flex flex-col justify-center items-center text-center text-zinc-600 text-lg font-bold'>
      <div>
      <Image alt='Web 3 and Metavers' src={Metaverse} className=' object-cover w-full' height={'300'} />
      </div>
      <div className='px-4 flex justify-items-stretch-center items-center h-[70px]'>
      <text>
      Web 3 and Metavers
